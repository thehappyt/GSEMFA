;(function () {
    ...
    var asCharge = function() {
        ...
        Object.defineProperty(this, "lbl",    { enumerable: false, configurable: false, writable: false,
            value: label({ color: vec(0.7,0.7,0.7), height: 14, font: 'bold', border: 0, box: false, line: false, opacity: 0, visible: true, text: '0' })    //background: vec(0.3,0.3,0.3), //normal normal bold 
        });
